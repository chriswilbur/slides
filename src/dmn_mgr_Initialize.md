...
```cpp [79: 6|8|16-21|50-52|59-60|73-78|80-83]
// -------------------------------------------------------------------------- //
// Function:    Initialize
...
Note:  
- Returns Fail if mdb_mgr is null  
- Since MDBs are also domains, we need to add the MDB Domains to our list of domains  
  - iterates thru a vector of domains, and add any domain found  
- instances_info passed in when we called initialize  
- Retrieve the domain's MDB Interface instance
- Briefly discussed earlier, using the DomainFactory singleton which class factory Create() func